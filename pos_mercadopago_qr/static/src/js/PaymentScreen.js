                ...
                if (line.payment_method.use_payment_terminal === "mp_qr"){
                    try {
                        rpc.query({
                            ...
                            args: [[], {'amount_total': line.amount, 'payment_method_id': line.payment_method.id, 'pos_session_id':line.order.pos_session_id, 'access_token_payment': order.mp_qr_payment_token}],
                        });
                    } catch (_e) {
